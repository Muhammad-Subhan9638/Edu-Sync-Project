          ...
          {taskList.map((task, index) => {
            return (
              <Tr key={index}>
                ...
                >
                  <i className="dlt-cursor fa-solid fa-pen-to-square text-primary d-flex justify-content-center"></i>
                </Td>
                <Td onClick={() => handleDeleteTask(task)}>
                  <i className="dlt-cursor fa-solid fa-trash text-danger text-center d-flex justify-content-center"></i>
                </Td>
              </Tr>
            );
          })}
