                        ...
                        <div className="row mt-3">
                            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                                <h6 className="text-uppercase fw-bold mb-4">
                                    <i className="fas fa-gem me-3 text-grayish"></i>Edu-Sync
                                </h6>
                                <p>
                                Edu-Sync.com is a free website, trusted by thousands of students and teachers, throughout the world.
                            ...
                            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                                ...
                                <p>
                                    <i className="fas fa-phone me-3 text-grayish"></i> (+92) 3096766172
                                </p>
                            </div>
                        </div>
                    </div>
