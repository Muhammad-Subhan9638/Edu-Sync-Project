                    ...
                    <div className="row">
                        {
                            ListOfClass.map((Class) => {
                                ...
                                return (
                                    ...
                                    //     </div>
                                    // </div>
                                    <div key={Class._id} className="card mx-2" style={{ width: "22rem", height: "450px", margin: "5px" }}>
                                        <img src={Class.img} className="card-img-top" alt="..." />
                                        <div className="card-body">
                                            <h5 className="card-title">{Class.Name}</h5>
                                            <a href={route} className="btn btn-primary text-white">Check books</a>
                                        </div>
                                    </div>
                                );
                            })}
