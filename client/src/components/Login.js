                    ...
                    <div className="screen__content">
                        <form className="login">
                            ...
                            <div className="login__field">
                                ...
                                <input
                                    type="email" className="login__input" placeholder="Email" value={userLogin.Email} name="Email" onChange={(e) => handleChange(e)}
                                />
                            </div>
                            <div className="login__field">
                                <i className="login__icon fas fa-lock"></i>
                                <input
                                    type="password" className="login__input" placeholder="Password" value={userLogin.Password} name="Password" onChange={(e) => handleChange(e)}
                                />
                            </div>
