    ...
    <>
      ...
      <div className={`Adminsidebar ${isSidebarOpen ? "open" : ""}`}>
        ...
        <nav className="sidebar-menu flex-grow-1">
          ...
          <Link to="/dashboard" className="Sidebarbtn text-white">
            <i className="fa-solid fa-globe"></i> Dashboard
          </Link>
          ...
          <div className="dropdown w-100 ms-4">
            ...
            <ul className="dropdown-menu">
              <li>
                <Link to="/line-chart" className="dropdown-item">
                  Line Chart
                </Link>
              </li>
              <li>
                <Link to="/bar-chart" className="dropdown-item">
                  Bar Chart
                </Link>
              </li>
              <li>
                <Link to="/stackedbar-chart" className="dropdown-item">
                  StackedBar Chart
                </Link>
              </li>
              <li>
                <Link to="/pie-chart" className="dropdown-item">
                  Pie Chart
                </Link>
              </li>
              <li>
                <Link to="/area-chart" className="dropdown-item">
                  Area Chart
                </Link>
              </li>
              <li>
                <Link to="/stackedarea-chart" className="dropdown-item">
                  StackedArea Chart
                </Link>
              </li>
            </ul>
        ...
        {/* Logout Button */}
        <button
          className="Sidebarbtn logout-btn mt-3 text-white"
