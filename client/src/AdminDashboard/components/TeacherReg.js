...
const TeacherRegistration = () => {
    ...
    const addTeacher = async (e) => {
        ...
        Axios.post("http://localhost:3001/add-teacher", teacherData).then((response) => {
            if (response.status === 200) {
                ...
                navigate("/dashboard/teacherslist")
            } else {
    ...
    function back() {
        return navigate("/dashboard/teacherslist")
    }
    return (
        <>
            <div style={{
                ...
                <div style={{ display: 'table-cell', background: 'linear-gradient(60deg, #0193a1, #8d24aa)' }}>
                    <Sidebar />
                </div>
                <div style={{
                    width: "100%",
                    ...
                    <div className="Tcontainer">
                        <button className='backBtn' onClick={back}><i className="fa-solid fa-backward"></i> Back to Teachers</button>
